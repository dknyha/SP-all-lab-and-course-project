;; Варіант 22 
;; Обчислити 4 значення функції Y = 5^x + cosx 
;; (x змінюється від 0,4 з кроком 0,15)

include /masm64/include64/masm64rt.inc

.const
    title0 db "Лабораторна 1, Завдання 1", 0	; назва вікна
    fmt0 db "Y = 5^x + cosx; X0 = 0.4; STEP = 0.15", 10,	; текст вікна
            "Y0 = %s", 10,
            "Y1 = %s", 10,
            "Y2 = %s", 10,
            "Y3 = %s", 10, 10,
            "Автор: 22 22", 0        
    const0 dq 5.0	; константи
    step0 dq 0.15	; крок 
...
m0:
    ...
    invoke fptoa, qword ptr[res0 + 18h], addr sres3 ; редагування результату 4 до числа з плаваючою точкою
